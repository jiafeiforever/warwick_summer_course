...
app.secret_key = 'your_secret_key'  # Flask-WTF 需要
...
class Enrollment(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    student_id = db.Column(db.Integer)  # ✅ 保持与 User 主键一致
...
# def my_enrolments():
#     return render_template("my_enrolments.html")  # ✅ 渲染模板，而不是再跳转
...
def teachers():
    ...
    instructors = [i[0] for i in instructors]  # 提取纯字符串
